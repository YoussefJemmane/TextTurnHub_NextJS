...
const StatCard = ({
  ...
  <div className="bg-white/60 backdrop-blur-sm p-6 rounded-2xl border border-gray-200/50 hover:shadow-md transition-all duration-300">
    <div
      className={`text-5xl font-bold bg-gradient-to-r from-${color}-600 to-${color}-500 bg-clip-text text-transparent mb-3`}
    >
      {value}
    </div>
    ...
    if (session.user.roles.includes("company")) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          />
          <div className="bg-white p-6 rounded-xl text-gray-900">
            <h3 className="font-semibold mb-2">Quick Actions</h3>
            <div className="space-y-2">
              <Link
                href="/textile-waste/create"
                className="flex items-center justify-between hover:bg-white/10 p-2 rounded-lg transition-all"
              >
    ...
    <div className="space-y-20">
      ...
      <section className="text-center py-16">
        <div className="mb-8">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            A sustainable platform connecting textile waste providers with
            artisans and creators to reduce waste and promote circular economy
      ...
      <section className="py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Together, we're building a more sustainable future for the textile
            industry
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          ...
          <StatCard
            value="200+"
            label="Artisan products created"
            color="blue"
          />
          <StatCard
            value="10 tons"
            label="Textile waste diverted from landfill"
            color="cyan"
          />
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-teal-50 to-blue-50 rounded-3xl p-12 text-center border border-teal-100">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Join our community of environmentally conscious companies, creative
          artisans, and mindful consumers.
        </p>
        <Link
